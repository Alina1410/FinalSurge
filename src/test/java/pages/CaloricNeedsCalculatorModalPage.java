...
public class CaloricNeedsCalculatorModalPage extends BasePage{
    ...
    public static CaloricNeedsCalculatorModalPage fillInForm(CaloricNeedsCalculator caloricNeedsCalculator) {
    ...
    public static CaloricNeedsCalculatorModalPage clickSaveButton(){
